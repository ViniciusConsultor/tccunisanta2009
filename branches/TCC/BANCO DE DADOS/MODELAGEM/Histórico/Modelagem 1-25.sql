...
CREATE TABLE Motorfornecedor (
       ...
       Data_de_Atualiza��o  datetime NULL,
       Flag_Ativo           bit NULL
)
go
...
ALTER TABLE Vendaproduto
       ADD PRIMARY KEY CLUSTERED (Codigo_da_Venda ASC, id_prdto ASC)
go
...
CREATE TABLE Familiamotor (
       ...
       Codigo_da_Familia_do_Motor_Real varchar(25) NULL,
...
ALTER TABLE Venda
       ADD PRIMARY KEY CLUSTERED (Codigo_da_Venda ASC)
go
...
CREATE TABLE Item (
       ...
       nom                  varchar(20) NULL,
       flg_ativo            bit NULL,
       Codigo_do_Item_Real  varchar(25) NULL,
       dat_alt              datetime NULL
)
go
...
ALTER TABLE Vendaproduto
       ADD FOREIGN KEY (Codigo_da_Venda)
                             REFERENCES Venda  (Codigo_da_Venda)
go
...
ALTER TABLE Compraordemcompra
       ADD FOREIGN KEY (Codigo_da_Ordem_de_Compra)
